...
const styles = StyleSheet.create({
  ...
  pushCard: { flexDirection: "row", alignItems: "center", gap: 12, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: Colors.accentBorder, borderRadius: Radius.md, backgroundColor: Colors.accentDim },
  ...
  rowUnread: { backgroundColor: Colors.accentGhost },
  ...
  iconUnread: { borderColor: Colors.accentBorderStrong },
